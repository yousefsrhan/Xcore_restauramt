...
abstract final class AppTheme {
  static ThemeData get dark {
    // تم استبدال GoogleFonts بـ TextStyle مباشر يعتمد على الخط المحلي Cairo
    TextStyle m(double sz, FontWeight w, {double ls = 0}) =>
        TextStyle(
            fontFamily: 'Cairo', // تأكد إن الاسم ده مطابق للي كتبته في الـ pubspec.yaml
            fontSize: sz,
            fontWeight: w,
            letterSpacing: ls,
    ...
    return ThemeData(
      ...
      brightness: Brightness.dark,
      colorScheme: cs,
      fontFamily: 'Cairo', // ده بيخلي الأبلكيشن كله يستخدم Cairo كـ Default
      scaffoldBackgroundColor: AppColors.background,
      canvasColor: AppColors.background,
      splashColor: const Color(0xFF6BFE9C).withOpacity(0.06),
      highlightColor: const Color(0xFF6BFE9C).withOpacity(0.04),
      ...
      appBarTheme: AppBarTheme(
        ...
        titleTextStyle: m(18, FontWeight.w700), // استخدمنا الـ Helper بتاعنا
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        hintStyle: m(14, FontWeight.w400).copyWith(color: AppColors.outline),
      ),
      chipTheme: ChipThemeData(
        backgroundColor: AppColors.surfaceContainerHigh,
        selectedColor: AppColors.primaryContainer,
        labelStyle: m(12, FontWeight.w700, ls: 0.8),
        secondaryLabelStyle: m(12, FontWeight.w700).copyWith(color: AppColors.onPrimary),
      ...
      snackBarTheme: SnackBarThemeData(
        backgroundColor: AppColors.surfaceContainerHigh,
        contentTextStyle: m(14, FontWeight.w500),
      ...
      dialogTheme: DialogThemeData(
        ...
        elevation: 0,
        shape: RoundedRectangleBorder(borderRadius: AppRadius.cardAll),
        titleTextStyle: m(22, FontWeight.w800, ls: -0.44),
        contentTextStyle: m(14, FontWeight.w500).copyWith(color: AppColors.onSurfaceVariant),
      ),
