    ...
    return Container(
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        Padding(padding: const EdgeInsets.fromLTRB(20, 8, 12, 16), child: Row(children: [
          const Text('تخصيص الطلب',
              style: TextStyle(fontSize: 24, fontWeight: FontWeight.w800, color: Colors.white, letterSpacing: -0.48)),
          const Spacer(),
        ...
        Flexible(child: SingleChildScrollView(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Text(widget.prefillItem?.name ?? 'Item',
                    style: const TextStyle(fontSize: 20, fontWeight: FontWeight.w700, color: Colors.white, letterSpacing: -0.4)),
            ...
            // Toppings Section
            Row(children: [
              const Text('اختر الإضافات',
                  style: TextStyle(fontSize: 12, fontWeight: FontWeight.w700, color: Colors.white, letterSpacing: 0.8)),
              const Spacer(),
              Container(padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 4),
                  decoration: BoxDecoration(color: AppColors.primary, borderRadius: BorderRadius.circular(4)),
                  child: const Text('اختياري',
                      style: TextStyle(fontSize: 9, fontWeight: FontWeight.w700, color: AppColors.onPrimary, letterSpacing: 0.8))),
            ]),
  ...
  Widget build(BuildContext context) => ScaleTransition(scale: _s,
      child: GestureDetector(
          ...
          child: Container(height: 60,
              ...
              child: Row(children: [
                const Text('إضافة للطلب',
                    style: TextStyle(fontSize: 16, fontWeight: FontWeight.w800, color: AppColors.onPrimary, letterSpacing: -0.2)),
                const Spacer(),
                Text('${widget.price.toStringAsFixed(0)} ج',
                    style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w800, color: AppColors.onPrimary, letterSpacing: -0.3)),
              ]))));
}